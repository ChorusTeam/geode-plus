...
public class DeepslateEmeraldGeodeModifier implements BiomeModifier {
    private final Holder<PlacedFeature> features;

    public DeepslateEmeraldGeodeModifier(Holder<PlacedFeature> features) {
    ...
    public Codec<? extends BiomeModifier> codec() {
        return DeepslateEmeraldGeodeModifier.makeCodec();
    }

    public static Codec<DeepslateEmeraldGeodeModifier> makeCodec() {
        return RecordCodecBuilder.create((config) -> {
            ...
            })).apply(config, DeepslateEmeraldGeodeModifier::new);
        });
    }
}