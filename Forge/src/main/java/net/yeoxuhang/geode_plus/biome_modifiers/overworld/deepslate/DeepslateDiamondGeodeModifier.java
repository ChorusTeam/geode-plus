...
public class DeepslateDiamondGeodeModifier implements BiomeModifier {
    private final Holder<PlacedFeature> features;

    public DeepslateDiamondGeodeModifier(Holder<PlacedFeature> features) {
    ...
    public Codec<? extends BiomeModifier> codec() {
        return DeepslateDiamondGeodeModifier.makeCodec();
    }

    public static Codec<DeepslateDiamondGeodeModifier> makeCodec() {
        return RecordCodecBuilder.create((config) -> {
            ...
            })).apply(config, DeepslateDiamondGeodeModifier::new);
        });
    }
}